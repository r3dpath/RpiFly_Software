...
class NRF24L01:
    def __init__(self, spi, cs, ce, channel=60, payload_size=21):
    ...
    def send_done(self, bp = True):
        if not (self.reg_read(STATUS) & (TX_DS | MAX_RT)) and bp:
